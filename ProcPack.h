...
#define ADD               2
#define SUBTRACT          6
#define COMP_LESSTHAN     7
#define NOR              12*/

const sc_time cpuOp2Op(10, SC_NS); // time between instructions
const sc_time cpuSleep(100, SC_NS);
//const sc_time rwAccess_t(w;
//const sc_time rwReadDelay_t(SC_ZERO_TIME);
//const sc_time rwWriteDelay_t(SC_ZERO_TIME);
